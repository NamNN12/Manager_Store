...
public class Fragment_tk_chi extends Fragment {
    ...
    public static ArrayList<GiaoDich> ds_tk_chi;
    public static ArrayList<GiaoDich> ds_tk_chis;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ds_tk_chi = new ArrayList<>();
        giaodichdao = new GiaodichDAO(getContext());

        ds_tk_chi = giaodichdao.getKhoanThu_Chi("Chi");
        khoanthu_adapter = new Tk_thu_Adapter(ds_tk_chi, getContext());
    ...
    private void Date2(){
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(getContext(), new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int i, int i1, int i2) {
                ...
                ds_tk_chis = giaodichdao.get_Tk_Thu(btn_date1.getText().toString(), btn_date2.getText().toString());
                khoanthu_adapter = new Tk_thu_Adapter(ds_tk_chis, getContext());
                rv_tk_thu.setAdapter(khoanthu_adapter);
